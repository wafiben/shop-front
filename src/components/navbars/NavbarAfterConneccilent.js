	...
	return (
		<div className={style.containenavebarrclient}>
			...
			<ul className={style.navebarreiconclinet }>
				...
				<li onClick={() => navigate("/client-space/home")} 
						...
						<svg xmlns="fi fi-sr-time-past" width="17" height="17" fill="currentColor" className="bi bi-house-door" viewBox="0 0 16 16">
				...
				<li className={style.iconnaveclient}>
					<li
						...
						<svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-alarm" viewBox="0 0 16 16">
				...
				<li className={style.iconnaveclient}>
					<li
						...
						<svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
